    ...
    <body>
      ...
      <c:set var="totalPrice" value="${0}" />
            <c:if test="${!empty orderProductList}">
                    <c:forEach items="${orderProductList}" var="orderProduct">
                                    ...
                                    <tr> 
                                        ...
                                        <td class="cart_delete">
                                            <a class="cart_quantity_delete" onclick="deleteRow(quentity${orderProduct.product.id}, this,${orderProduct.product.id},${orderProduct.product.price})">
                ...
                <a class="btn btn-primary" onclick="shippingOrder();" id="shippingOrder" style="margin-bottom: 10px;text-align: right">Order</a>
            </div>
        </section> <!--/#cart_items-->
